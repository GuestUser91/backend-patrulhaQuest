...
router.get('/:patrolId', authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
...
router.post('/:patrolId/members', authMiddleware, leaderOnly, async (req: AuthRequest, res: Response) => {
  try {
    const { patrolId } = req.params;
    ...
    if (
      error.message === 'Patrulha não encontrada' ||
...
router.delete('/:patrolId/members/:studentId', authMiddleware, leaderOnly, async (req: AuthRequest, res: Response) => {
  try {
...
router.post('/:patrolId/points', authMiddleware, leaderOnly, async (req: AuthRequest, res: Response) => {
  try {
    const { patrolId } = req.params;
...
router.delete('/:patrolId', authMiddleware, leaderOnly, async (req: AuthRequest, res: Response) => {
  try {
    const { patrolId } = req.params;
...
router.get('/students/available', authMiddleware, leaderOnly, async (req: AuthRequest, res: Response) => {
  try {
...
router.get('/students/all', authMiddleware, leaderOnly, async (req: AuthRequest, res: Response) => {
  try {
...
router.get('/:patrolId/members', authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
    const { patrolId } = req.params;
